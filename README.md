...
- Install the requirements: 
    ...
    ```
- (Optional) If you have a GPU and want to use CUDA, run `scripts/install_cuda.sh` (you might need to change the index-url to the appropriate [CUDA version][https://pytorch.org/get-started/locally/])
